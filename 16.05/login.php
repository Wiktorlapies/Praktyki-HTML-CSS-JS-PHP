    ...
    <main>
        ...
        <form action="" method="post" class="login-form">
            ...
            <section class="operations">
                ...
                <input type="submit" value="Zaloguj" class="operation-button submit-button" id="loginSubmitButton">
            </section>
        </form>
        ...
        <form action="" method="post" class="register-form display-none">
            ...
            <section class="operations">
                <input type="reset" value="Wyczyść" class="operation-button" onclick="clearForm()">
                <input type="submit" value="Zarejestruj" class="operation-button submit-button" id="registerSubmitButton">
            </section>
        </form>
    </main>
</body>
